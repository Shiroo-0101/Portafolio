...
$id=intval($_GET['id']);
$sql=mysqli_query($con,"update proyectos set image2='$propic' where ID='$id'");
echo "<p><script>Swal.fire({ title: 'ÉXITO', text: 'Actualizado exitosamente', icon: 'success', button: 'Cerrar' }).then(() => { window.location.href = 'manage-project.php'; });</script></p>";
}
}
?>
...
?>
                                        <div class="form-group">
                                            ...
                                            <input id="namesc" name="namesc" type="text" class="form-control"
                                                readonly="true" value="<?php echo htmlentities($row['projecTitle']);?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Foto seleccionada </label>
</br>
