...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <div class="carousel-inner">
    ...
    while ($fila = mysqli_fetch_assoc($resultado)) {
      ...
      echo '<h1 class="heading mb-3"><strong>Santa Virginia Centurione Bracelli <br> </strong></h1>';
  ...
  <div class="container">
    <div class="row justify-content-between align-items-center">
      ...
      <div class="col-lg-6">
        ...
        <?php
                    include('includes/config.php');
          $ret=mysqli_query($con,"SELECT * FROM tbldifferentimgs WHERE Fototype='Bracelliphoto2'");
          while ($row=mysqli_fetch_array($ret)) {
            $Imagen = $row['ProfilePic'];
          ?>
                <div class="popup-window rounded shadow-lg">
                <img src="/Asilo/Asilo/admin/images/<?php echo $Imagen; ?>" alt="Image" class="img-fluid rounded">
        ...
        <?php
                    include('includes/config.php');
          $ret=mysqli_query($con,"SELECT * FROM tbldifferentimgs WHERE Fototype='Bracelliphoto'");
          while ($row=mysqli_fetch_array($ret)) {
            $Imagen = $row['ProfilePic'];
          ?>
                <div class="popup-window rounded shadow-lg">
