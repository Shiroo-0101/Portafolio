...
<head>
  ...
  <title>Refugio Santa Virginia || Página de noticias</title>
  <!-- base:css -->
...
if(isset($_POST['submit']))
  {
     ...
     $query=mysqli_query($con,"update tblpage set PageTitle='$pagetitle',PageDescription='$pagedes', Email='$frase' where  PageType='noticia'");
    if ($query) {
 
      echo "<script>
      Swal.fire({
          title: 'ÉXITO',
          text: 'Noticia ha sido actualizada.',
          icon: 'success',
          button: 'Cerrar'
      });
  </script>";
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Página de noticias</h4>
...
?>
                    ...
                    <div class="form-group">
                      <label for="exampleInputPhrase1">Frase</label>
                      <textarea class="form-control" name="frase" id="frase" rows="5"><?php  echo $row['Email'];?></textarea>
                    </div>
