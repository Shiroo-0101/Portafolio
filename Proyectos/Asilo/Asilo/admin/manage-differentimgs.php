...
<head>
    ...
    <title>Refugio Santa Virginia || Gestionar imagenes</title>
    <!-- base:css -->
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item ml-0">
                        <h4 class="mb-0">Gestionar Imagenes de servicios</h4>
                    </li>
                    <li class="nav-item">
                        <div class="d-flex align-items-baseline">
                            <p class="mb-0">Inicio</p>
                            <i class="typcn typcn-chevron-right"></i>
                            <p class="mb-0">Gestionar Imagenes</p>
                        </div>
                    </li>
                </ul>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <h4 class="card-title" style="padding-left: 20px; padding-top: 20px;">Gestionar
                                    Imagenes</h4>
                         ...
                         $query=mysqli_query($con,"select * from tbldifferentimgs");
$cnt=1;

while($row=mysqli_fetch_array($query))
{
    $p_thumbnail = $row["ProfilePic"];
?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="edit-differentimgs.php?id=<?php echo $row['ID']?>"
                ...
                function confirmDelete(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = 'manage-differentimgs.php?id=' + id + '&del=delete';
                        }
                    });
