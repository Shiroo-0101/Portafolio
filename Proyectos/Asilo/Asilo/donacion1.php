        ...
        <section id="cta" class="cta img-bg    bg-primary"
            ...
            <div class="container d-flex justify-content-center align-items-center h-100" data-aos="zoom-in">
                <div class="text-center">
                    <h1 class="display-1 fw-bolder" style="color: #FFFFFF; font-size: 3rem;">Productos Requeridos</h1>
                ...
                <div class="row">
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="card mb-4">
                                <img src="admin/images/<?php echo htmlentities($p_thumbnail); ?>" alt="Image"
                                    class="card-img-top">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo htmlentities($row['DonacionTitle']); ?></h5>
                                    <p class="card-text"><?php echo htmlentities($row['CreationDate']); ?></p>
                                    <a href="donacion_detail.php?id=<?php echo $row['ID']?>"
                                                            class="btn btn-primary btn-sm btn-icon-text mr-3">Donar <i
