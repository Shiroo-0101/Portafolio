...
include('includes/config.php');
    if(isset($_POST['submit']))
  {
    ...
    $myemail=$_POST['email'];
  $mypassword=$_POST['token'];

     $query=mysqli_query($con, "update configmail set email ='$myemail', token='$mypassword' where id='3'");
    if ($query) {
...
$ret=mysqli_query($con,"select * from configmail where id='3'");
$cnt=1;
...
//$myemail = "refugiosantavirginia7@gmail.com";
//$mypassword = "xzwftnbgcsdghpjk";
