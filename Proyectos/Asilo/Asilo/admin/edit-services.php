...
Swal.fire({ 
    title: 'ÉXITO', 
    text: 'Detalle de servicio actualizado con éxito', 
    icon: 'success', 
    button: 'Cerrar' 
}).then(() => {
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                  <h4 class="card-title"> Actualizar servicios</h4>
...
<a href="change-servicesimage.php?id=<?php echo $row['ID'];?>">Cambiar imagen</a>
</br>
