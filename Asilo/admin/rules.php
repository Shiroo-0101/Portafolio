...
<head>
  ...
  <title>Refugio Santa Virginia || Página de normas</title>
  <!-- base:css -->
...
$pagedes=$_POST['pagedes'];
    ...
    if ($query) {
      ...
      Swal.fire({
          title: 'ÉXITO',
          text: 'Reglas actualizadas exitosamente.',
          icon: 'success',
          confirmButtonText: 'OK'
      }).then(() => {
          window.location.href = 'rules.php'; // Reemplaza 'your-page.php' con la URL deseada
      });
  </script>";  }
  else
    {
