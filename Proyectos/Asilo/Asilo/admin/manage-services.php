...
<head>
    ...
    <title>Refugio Santa Virginia || Gestionar servicios</title>
    <!-- base:css -->
...
Swal.fire({ 
    ...
    window.location.href = 'manage-services.php'; // Reemplaza 'pagina-destino.php' con la URL a la que deseas redirigir
});
</script>";
          }
?>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
                <ul class="navbar-nav mr-lg-2">
                    <li class="nav-item ml-0">
                        <h4 class="mb-0">Gestionar servicios</h4>
                    </li>
                    <li class="nav-item">
                        <div class="d-flex align-items-baseline">
                            <p class="mb-0">Inicio</p>
                            <i class="typcn typcn-chevron-right"></i>
                            <p class="mb-0">Gestionar servicios</p>
                        </div>
                    </li>
                </ul>
                ...
                function confirmDelete(id) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = 'manage-services.php?id=' + id + '&del=delete';
                        }
                    });
