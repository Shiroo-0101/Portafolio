...
echo "<p><script>Swal.fire({ title: 'ÉXITO', text: 'Actualizado exitosamente', icon: 'success', button: 'Cerrar' }).then(() => { window.location.href = 'manage-scdetails.php'; });</script></p>";
}
}
?>
...
?>
                                        <div class="form-group">
                                            ...
                                            <input id="namesc" name="namesc" type="text" class="form-control"
                                                readonly="true" value="<?php echo htmlentities($row['Name']);?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Antigua foto de perfil</label>
