...
$id=intval($_GET['id']);
$sql=mysqli_query($con,"update tbldonacion set Image='$propic' where ID='$id'");
echo "<p><script>Swal.fire({ title: 'ÉXITO', text: 'Actualizado exitosamente', icon: 'success', button: 'Cerrar' }).then(() => { window.location.href = 'manage-donacion.php'; });</script></p>";
}
}
?>
...
?>
                                        <div class="form-group">
                                            ...
                                            <input id="namesc" name="namesc" type="text" class="form-control"
                                                readonly="true" value="<?php echo htmlentities($row['DonacionTitle']);?>">
                                        </div>
