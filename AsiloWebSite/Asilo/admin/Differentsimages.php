...
<head>
    ...
    <title>Refugio Santa Virginia || Añadir imagenes</title>
    <!-- base:css -->
...
if (empty($sertitle) ||  empty($propic)) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $sql = mysqli_query($con, "INSERT INTO tbldifferentimgs (ServiceTitle, ProfilePic) VALUES ('$sertitle', '$propic')");
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Añadir imagenes de diferentes servicios</h4>
