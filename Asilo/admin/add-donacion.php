...
if (empty($sertitle) || empty($serdes) || empty($propic)) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $sql = mysqli_query($con, "INSERT INTO tbldonacion (DonacionTitle, DonacionDescription, Image) VALUES ('$sertitle', '$serdes', '$propic')");
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Añadir donaciones requeridas</h4>
                                    <p class="card-description">
                                    Añadir donaciones requeridas
                                    </p>
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Foto del producto</label>
