...
<head>
    ...
    <title>Refugio Santa Virginia || Añadir servicios</title>
    <!-- base:css -->
...
if (empty($sertitle) || empty($serdes) || empty($propic)) {
    ...
    if (!in_array($extension, $allowed_extensions)) {
        ...
        $sql = mysqli_query($con, "INSERT INTO tblservices (ServiceTitle, ServiceDescription, ProfilePic) VALUES ('$sertitle', '$serdes', '$propic')");
        
        // Verificar si la consulta se ejecutó correctamente
        if ($sql) {
            echo "<script>Swal.fire({ title: 'ÉXITO', text: 'Se ha añadido con éxito', icon: 'success', button: 'Cerrar' });</script>";
        } else {
            echo "<script>Swal.fire({ title: 'ERROR', text: 'Error al añadir el servicio.', icon: 'error', button: 'Cerrar' });</script>";
        }
    }
}
}
                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-md-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Añadir servicios</h4>
                                    ...
                                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputUsername1">Título del servicio</label>
